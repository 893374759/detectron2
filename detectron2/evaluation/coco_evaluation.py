        ...
        for task in sorted(tasks):
            coco_eval = (
                _evaluate_predictions_on_coco(
                    self._coco_api, coco_results, task, kpt_oks_sigmas=self._kpt_oks_sigmas, dataset_name=self.dataset_name
                )
...
def _evaluate_predictions_on_coco(coco_gt, coco_results, iou_type, kpt_oks_sigmas=None, dataset_name=None):
    """
    ...
    if 'ICDAR2019' in dataset_name:
        coco_eval = ICDAR2019_COCOeval(coco_gt, coco_dt, iou_type)
    else:
...
class ICDAR2019_COCOeval(COCOeval):
    def summarize(self):
        '''
